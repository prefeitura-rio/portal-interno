...
export const getAvatars = async (
  ...
  return customFetchRmi<getAvatarsResponse>(getGetAvatarsUrl(params), {
    ...options,
    method: 'GET',
  })
}
...
export const postAvatars = async (
  ...
  return customFetchRmi<postAvatarsResponse>(getPostAvatarsUrl(), {
    ...options,
    method: 'POST',
...
export const deleteAvatarsId = async (
  ...
  return customFetchRmi<deleteAvatarsIdResponse>(getDeleteAvatarsIdUrl(id), {
    ...options,
    method: 'DELETE',
  })
}
...
export const getCitizenCpfAvatar = async (
  ...
  return customFetchRmi<getCitizenCpfAvatarResponse>(
...
export const putCitizenCpfAvatar = async (
  ...
  return customFetchRmi<putCitizenCpfAvatarResponse>(
