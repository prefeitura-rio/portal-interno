...
export const getAdminBetaGroups = async (
  ...
  return customFetchRmi<getAdminBetaGroupsResponse>(
...
export const postAdminBetaGroups = async (
  ...
  return customFetchRmi<postAdminBetaGroupsResponse>(
    getPostAdminBetaGroupsUrl(),
    {
      ...options,
      method: 'POST',
...
export const getAdminBetaGroupsGroupId = async (
  ...
  return customFetchRmi<getAdminBetaGroupsGroupIdResponse>(
...
export const putAdminBetaGroupsGroupId = async (
  ...
  return customFetchRmi<putAdminBetaGroupsGroupIdResponse>(
...
export const deleteAdminBetaGroupsGroupId = async (
  ...
  return customFetchRmi<deleteAdminBetaGroupsGroupIdResponse>(
