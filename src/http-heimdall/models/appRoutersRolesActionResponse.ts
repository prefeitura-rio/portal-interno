 ...
 */
import type { AppRoutersRolesActionResponseDescription } from './appRoutersRolesActionResponseDescription'

/**
 * Response model for action information.
 */
export interface AppRoutersRolesActionResponse {
  /** Unique identifier for the action */
  id: number
  /** Action name */
  name: string
  /** Action description */
  description?: AppRoutersRolesActionResponseDescription
}
