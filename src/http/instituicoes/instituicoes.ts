...
export type getApiV1InstituicoesResponseComposite =
  | getApiV1InstituicoesResponse200
  | getApiV1InstituicoesResponse500

export type getApiV1InstituicoesResponse =
  getApiV1InstituicoesResponseComposite & {
    headers: Headers
  }

export const getGetApiV1InstituicoesUrl = (
  ...
  return stringifiedParams.length > 0
    ? `/api/v1/instituicoes?${stringifiedParams}`
    : `/api/v1/instituicoes`
}

export const getApiV1Instituicoes = async (
  params?: GetApiV1InstituicoesParams,
  options?: RequestInit
...
export type postApiV1InstituicoesResponse500 = {
  data: ModelsErrorResponse
  status: 500
}

export type postApiV1InstituicoesResponseComposite =
  | postApiV1InstituicoesResponse201
  | postApiV1InstituicoesResponse400
  | postApiV1InstituicoesResponse500

export type postApiV1InstituicoesResponse =
  postApiV1InstituicoesResponseComposite & {
    headers: Headers
  }
...
export const postApiV1Instituicoes = async (
  ...
  return customFetch<postApiV1InstituicoesResponse>(
    getPostApiV1InstituicoesUrl(),
    {
      ...
      body: JSON.stringify(modelsInstituicaoEnsinoBody),
    }
  )
}
...
export type getApiV1InstituicoesIdResponse404 = {
  data: ModelsErrorResponse
  status: 404
}

export type getApiV1InstituicoesIdResponse500 = {
  data: ModelsErrorResponse
  status: 500
}

export type getApiV1InstituicoesIdResponseComposite =
  | getApiV1InstituicoesIdResponse200
  | getApiV1InstituicoesIdResponse400
  | getApiV1InstituicoesIdResponse404
  | getApiV1InstituicoesIdResponse500

export type getApiV1InstituicoesIdResponse =
  getApiV1InstituicoesIdResponseComposite & {
    headers: Headers
  }
...
export const getApiV1InstituicoesId = async (
  id: number,
  options?: RequestInit
...
export type putApiV1InstituicoesIdResponse500 = {
  data: ModelsErrorResponse
  status: 500
}

export type putApiV1InstituicoesIdResponseComposite =
  | putApiV1InstituicoesIdResponse200
  | putApiV1InstituicoesIdResponse400
  | putApiV1InstituicoesIdResponse500

export type putApiV1InstituicoesIdResponse =
  putApiV1InstituicoesIdResponseComposite & {
    headers: Headers
  }
...
export const putApiV1InstituicoesId = async (
  id: number,
  modelsInstituicaoEnsinoBody: ModelsInstituicaoEnsinoBody,
  options?: RequestInit
...
export type deleteApiV1InstituicoesIdResponse500 = {
  data: ModelsErrorResponse
  status: 500
}

export type deleteApiV1InstituicoesIdResponseComposite =
  | deleteApiV1InstituicoesIdResponse200
  | deleteApiV1InstituicoesIdResponse400
  | deleteApiV1InstituicoesIdResponse500

export type deleteApiV1InstituicoesIdResponse =
  deleteApiV1InstituicoesIdResponseComposite & {
    headers: Headers
  }
...
export const deleteApiV1InstituicoesId = async (
  id: number,
  options?: RequestInit
