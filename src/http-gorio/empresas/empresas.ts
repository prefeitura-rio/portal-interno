...
export type getApiV1EmpresasResponseComposite =
  | getApiV1EmpresasResponse200
  | getApiV1EmpresasResponse500
...
export const getGetApiV1EmpresasUrl = (params?: GetApiV1EmpresasParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/v1/empresas?${stringifiedParams}`
    : `/api/v1/empresas`
}

export const getApiV1Empresas = async (
...
export type postApiV1EmpresasResponse500 = {
  data: ModelsErrorResponse
  status: 500
}

export type postApiV1EmpresasResponseComposite =
  | postApiV1EmpresasResponse201
  | postApiV1EmpresasResponse400
  | postApiV1EmpresasResponse500
...
export const postApiV1Empresas = async (
...
export type getApiV1EmpresasIdResponse404 = {
  data: ModelsErrorResponse
  status: 404
}

export type getApiV1EmpresasIdResponse500 = {
  data: ModelsErrorResponse
  status: 500
}

export type getApiV1EmpresasIdResponseComposite =
  | getApiV1EmpresasIdResponse200
  | getApiV1EmpresasIdResponse400
  | getApiV1EmpresasIdResponse404
  | getApiV1EmpresasIdResponse500
...
export const getApiV1EmpresasId = async (
  id: number,
  options?: RequestInit
...
export type putApiV1EmpresasIdResponse500 = {
  data: ModelsErrorResponse
  status: 500
}

export type putApiV1EmpresasIdResponseComposite =
  | putApiV1EmpresasIdResponse200
  | putApiV1EmpresasIdResponse400
  | putApiV1EmpresasIdResponse500
...
export const putApiV1EmpresasId = async (
  id: number,
  modelsEmpresaBody: ModelsEmpresaBody,
  options?: RequestInit
...
export type deleteApiV1EmpresasIdResponse500 = {
  data: ModelsErrorResponse
  status: 500
}

export type deleteApiV1EmpresasIdResponseComposite =
  | deleteApiV1EmpresasIdResponse200
  | deleteApiV1EmpresasIdResponse400
  | deleteApiV1EmpresasIdResponse500

export type deleteApiV1EmpresasIdResponse =
  deleteApiV1EmpresasIdResponseComposite & {
    headers: Headers
  }
...
export const deleteApiV1EmpresasId = async (
  id: number,
  options?: RequestInit
