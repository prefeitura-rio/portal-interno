...
export const getApiV1EmpregabilidadeTermosUsoCpf = async (
  ...
  return customFetchGoRio<getApiV1EmpregabilidadeTermosUsoCpfResponse>(
...
export const putApiV1EmpregabilidadeTermosUsoCpfAccept = async (
  ...
  return customFetchGoRio<putApiV1EmpregabilidadeTermosUsoCpfAcceptResponse>(
...
export const getApiV1EmpregabilidadeTermosUsoCpfDetails = async (
  ...
  return customFetchGoRio<getApiV1EmpregabilidadeTermosUsoCpfDetailsResponse>(
