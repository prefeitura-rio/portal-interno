...
/**
 * NOVO - Endpoint para enviar curso para revisão (Casa Civil)
 * Transição: draft/needs_changes → in_review
 */
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json({
      message: 'Curso enviado para revisão com sucesso',
      data,
      success: true,
    })
  } catch (error) {
    console.error('Erro ao enviar curso para revisão:', error)
    return NextResponse.json(
