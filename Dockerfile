...
ARG NEXT_PUBLIC_HEIMDALL_BASE_API_URL
ARG NEXT_PUBLIC_RMI_BASE_API_URL
ARG NEXT_PUBLIC_INSTITUICAO_ID_DEFAULT
ARG NEXT_PUBLIC_FEATURE_FLAG
ARG NEXT_PUBLIC_BASE_URL_APP
ARG NEXT_PUBLIC_ENVIRONMENT
ARG NEXT_PUBLIC_FEATURE_FLAG_EMPREGO_TRABALHO
...
ENV NEXT_PUBLIC_HEIMDALL_BASE_API_URL=$NEXT_PUBLIC_HEIMDALL_BASE_API_URL
ENV NEXT_PUBLIC_RMI_BASE_API_URL=$NEXT_PUBLIC_RMI_BASE_API_URL
...
ENV NEXT_PUBLIC_BASE_URL_APP=$NEXT_PUBLIC_BASE_URL_APP
ENV NEXT_PUBLIC_ENVIRONMENT=$NEXT_PUBLIC_ENVIRONMENT
ENV NEXT_PUBLIC_FEATURE_FLAG_EMPREGO_TRABALHO=$NEXT_PUBLIC_FEATURE_FLAG_EMPREGO_TRABALHO
